                    ...
                    <div class="main_screen">
                        ...
                        <div class="app_box">
                            <div class="file">
                                ...
                                <form action="php/rename.php?path=<?php echo $current_path ?>&name=<?php echo $name ?>" method="post">
                                    <div class="file_manager">
                                        <input  id="create_folder" name="new_name" type="text" value="<?php echo $name ?>">
                                    </div>

                                    <div class="file_action">
                                        <span>
                                            <button style="background: none;border:none;cursor:pointer;" type="submit">rename</button>
                                        </span>
