                    ...
                    <div class="main_screen">
                        ...
                        <div class="app_box">
                            <div class="file">
                                ...
                                <form action="php/create_folder.php?path=<?php echo $current_path  ?>" method="post">
                                    <div class="file_manager">
                                        <input  id="create_folder" name="create_folder" type="text" placeholder="Enter folder name">
                                    </div>

                                    <div class="file_action">
                                        <span>
                                            <button style="background: none;border:none;cursor:pointer;" type="submit">create</button>
                                        </span>
