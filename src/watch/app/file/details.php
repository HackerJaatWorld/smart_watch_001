                        ...
                        <div class="app_box">
                            <div class="file">
                                ...
                                <?php
                                    ...
                                    $queary = "SELECT * FROM files WHERE id = '$id'";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <div class="folder">
                                                <div>Name - <span><?php echo $row['name'] ?></span></div>
                                            </div>
                                            <div class="folder">
                                                <div>Date - <span><?php echo $row['date'] ?></span></div>
                                            </div>
                                            <div class="folder">
                                                <div>Size - <span><?php echo $row['size'] / 1024 ?></span></div>
                                            </div>
                                            <div class="folder">
                                                <div>Path - <span><?php echo $row['path']?></span></div>
                                            </div>
